  ...
  <div class="z-50">
    ...
    <Menu v-slot="{ open }" as="template" :key="'main-menu-mobile'">
      <div class="h-full">
        ...
        >
          <div class="flex gap-4 w-full items-center" :class="{'text-primary':open}">
            <div>{{ t("view.menu") }}</div>
        ...
        >
          <MenuItems
            ...
            v-if="open"
            static
            class="absolute z-[301] origin-top bottom-0 left-0 transition animation-delay-150 w-full bg-white drop-shadow-md p-2 rounded-b-md flex flex-col outline-none border-t-2 border-primary translate-y-full "
          >
            <!-- Level #1 -->
              ...
              <Menu as="div" class="p-3" v-slot="{ open: firstLevelOpen }">
                <MenuButton as="template">
                  <div
                    ...
                    :class="firstLevelOpen ? 'text-primary' : ''"
                  >
                    <div>
                        ...
                        <Menu as="div" class="p-2" v-slot="{ open: openSubMenu }">
                          <MenuButton as="template">
                            <div
                              ...
                              :class="openSubMenu ? 'text-primary' : ''"
                              v-if="
